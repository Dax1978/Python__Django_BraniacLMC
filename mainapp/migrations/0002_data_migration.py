# Generated by Django 3.2 on 2022-12-22 21:15
...
def forwards_func(apps, schema_editor):
    ...
    News.objects.create(
        ...
        body="До прихода в компанию «1С-Битрикс» начинал карьеру в качестве системного администратора. В 2009 перешёл на должность DevOps-инженера, где и трудится по сей день, развиваясь в своей сфере. Дмитрий — сертифицированный специалист компании Bitrix. На его счету более 30 успешно реализованных проектов веб-проектами на базе 1C-Bitrix",
    )
    News.objects.create(
